...
>(({ className, children, ...props }, ref) => (
  ...
  >
    <ScrollAreaPrimitive.Viewport
      // Radix wraps children in a `display:table` div that sizes to natural
      // content width — overrides to `block` so wide tables (`min-w-max`)
      // don't blow the page horizontally.
